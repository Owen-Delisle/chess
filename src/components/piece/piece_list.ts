...
export default class PieceList {
    public static piece_list: Piece[] = [
        ...
        // new Pawn("pawn_b1", "F7", Pawn_B_SVG, PieceType.pawn, Color.black),
        // new Queen("queen_b", "B6", Queen_B_SVG, PieceType.queen, Color.black),
        // new Bishop("bishop_b1", "C8", Bishop_B_SVG, PieceType.bishop, Color.black),
        // new Pawn("pawn_w1", "F2", Pawn_W_SVG, PieceType.pawn, Color.white),
        // new Bishop("bishop_w1", "B3", Bishop_W_SVG, PieceType.bishop, Color.white),
        // new King("king_w", "G1", King_W_SVG, PieceType.king, Color.white)
        //END TODO
