...
function should_en_passant(): SubjectResultBoard {
    const black_pawn: Piece = piece_factory('pawn_b', 'D5', PieceType.pawn, Color.black)
    const white_pawn: Piece = piece_factory('pawn_w', 'E5', PieceType.pawn, Color.white)
...
function pawn_wasnt_last_move(): SubjectResultBoard {
    const black_pawn: Piece = piece_factory('pawn_b', 'D5', PieceType.pawn, Color.black)
    const white_pawn: Piece = piece_factory('pawn_w', 'E5', PieceType.pawn, Color.white)
    const rando_pawn: Piece = piece_factory('pawn_w1', 'A5', PieceType.pawn, Color.white)
