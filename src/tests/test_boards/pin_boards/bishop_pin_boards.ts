...
const bishop_pin_boards: { title: string, board: Piece[], subject_piece: Piece, expected_result: string[] }[] = [
    bishop_pin_north(),
...
function bishop_pin_north(): { title: string, board: Piece[], subject_piece: Piece, expected_result: string[] } {
...
function bishop_pin_north_east(): { title: string, board: Piece[], subject_piece: Piece, expected_result: string[] } {
    const subject_piece: Piece = piece_factory('bishop_w1', 'E2', PieceType.bishop, Color.white)
    return {
...
function bishop_pin_east(): { title: string, board: Piece[], subject_piece: Piece, expected_result: string[] } {
    const subject_piece: Piece = piece_factory('bishop_w1', 'E2', PieceType.bishop, Color.white)
    return {
...
function bishop_pin_south_east(): { title: string, board: Piece[], subject_piece: Piece, expected_result: string[] } {
    const subject_piece: Piece = piece_factory('bishop_w1', 'E2', PieceType.bishop, Color.white)
    return {
...
function bishop_pin_south(): { title: string, board: Piece[], subject_piece: Piece, expected_result: string[] } {
    const subject_piece: Piece = piece_factory('bishop_w1', 'E2', PieceType.bishop, Color.white)
    return {
...
function bishop_pin_south_west(): { title: string, board: Piece[], subject_piece: Piece, expected_result: string[] } {
    const subject_piece: Piece = piece_factory('bishop_w1', 'E2', PieceType.bishop, Color.white)
    return {
...
function bishop_pin_west(): { title: string, board: Piece[], subject_piece: Piece, expected_result: string[] } {
    const subject_piece: Piece = piece_factory('bishop_w1', 'E2', PieceType.bishop, Color.white)
    return {
...
function bishop_pin_north_west(): { title: string, board: Piece[], subject_piece: Piece, expected_result: string[] } {
    const subject_piece: Piece = piece_factory('bishop_w1', 'E2', PieceType.bishop, Color.white)
    return {
